...
(It is highly recommended to look at the starter project for Polymer if you are not familure with the language. This project can be found here: https://developers.google.com/web/tools/polymer-starter-kit/)
